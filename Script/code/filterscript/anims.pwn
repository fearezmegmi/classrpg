...
stock PlayerCommandText(playerid, cmdtext[])
{
	...
	if(strcmp(cmd,"/animlist",true)==0)
	{
        ...
        SendClientMessage(playerid,WHITE,"/fekves1 - /fekves2 - /fekves3 - /leül - /dj");
    ...
    if(strcmp(cmd, "/carjacked2", true) == 0) {
	    ...
	    if (GetPlayerState(playerid) == PLAYER_STATE_ONFOOT) return SendClientMessage(playerid, RED, "Jármûben? A-a! Elég visszaélés volt a /fall-al!");
	#endif
		...
		if (!strcmp(jatekosneve, "Charlie_Cortez", true))
   		{
			...
			SendClientMessageToAll(0x009DFFFF, "-          Rázzad te is velünk! Ne maradj ki a buliból       -");
		...
		if (!strcmp(jatekosneve, "Charlie_Cortez", true))
   		{
			...
			SendClientMessage(playerid, 0xFF0060FF, "-          Újratöltve!                                    -");
  			return 1;
	   }
    }
    // Drunk
    ...
    {
        if (!strlen(cmdtext[7])) return SendClientMessage(playerid,0xEFEFF7AA,"Használat: /smoke [1-4]");
    	switch (cmdtext[7])
    	{
        	...
        	default: SendClientMessage(playerid,0xEFEFF7AA,"Használat: /smoke [1-4]");
    	}
    	return 1;
    }
	// Sit
    ...
    // ChairSit
    if(strcmp(cmd, "/chairsit", true) == 0 || strcmp(cmd, "/leül", true) == 0) {
    ...
    {
        if (!strlen(cmdtext[5])) return SendClientMessage(playerid,0xEFEFF7AA,"Használat: /sup [1-3]");
    	switch (cmdtext[5])
    	{
        	...
        	default: SendClientMessage(playerid,0xEFEFF7AA,"Használat: /sup [1-3]");
    	}
    	return 1;
    }
    ...
    {
        if (!strlen(cmdtext[5])) return SendClientMessage(playerid,0xEFEFF7AA,"Használat: /rap [1-4]");
    	switch (cmdtext[5])
    	{
        	...
        	default: SendClientMessage(playerid,0xEFEFF7AA,"Használat: /rap [1-4]");
    	}
    	return 1;
    }
    ...
    {
        if (!strlen(cmdtext[7])) return SendClientMessage(playerid,0xEFEFF7AA,"Használat: /knife [1-4]");
    	switch (cmdtext[7])
    	{
        	...
        	default: SendClientMessage(playerid,0xEFEFF7AA,"Használat: /knife [1-4]");
    	}
    	return 1;
    }
    ...
    {
        if (!strlen(cmdtext[8])) return SendClientMessage(playerid,0xEFEFF7AA,"Használat: /basket [1-6]");
    	switch (cmdtext[8])
    	{
        	...
        	default: SendClientMessage(playerid,0xEFEFF7AA,"Használat: /basket [1-6]");
    	}
    	return 1;
    }
    ...
    {
        if (!strlen(cmdtext[8])) return SendClientMessage(playerid,0xEFEFF7AA,"Használat: /reload [deagle/smg/ak/m4]");
       	...
       	else SendClientMessage(playerid,0xEFEFF7AA,"Használat: /reload [deagle/smg/ak/m4]");
    	return 1;
    }

    if(strcmp(cmd, "/gwalk", true) == 0)
    {
        if (!strlen(cmdtext[6])) return SendClientMessage(playerid,0xEFEFF7AA,"Használat: /gwalk [1/2]");
        new style = strval(cmdtext[6]);
       	...
       	else SendClientMessage(playerid,0xEFEFF7AA,"Használat: /gwalk [1/2]");
    	return 1;
    }
    ...
    {
        if (!strlen(cmdtext[5])) return SendClientMessage(playerid,0xEFEFF7AA,"Használat: /aim [1-3]");
    	switch (cmdtext[5])
    	{
        	...
        	default: SendClientMessage(playerid,0xEFEFF7AA,"Használat: /aim [1-3]");
    	}
    	return 1;
    }
    ...
    {
        if (!strlen(cmdtext[6])) return SendClientMessage(playerid,0xEFEFF7AA,"Használat: /lean [1-2]");
    	switch (cmdtext[6])
    	{
        	case '1': LoopingAnim(playerid,"GANGS","leanIDLE",4.0,0,1,1,1,0);
        	case '2': LoopingAnim(playerid,"MISC","Plyrlean_loop",4.0,0,1,1,1,0);
        	default: SendClientMessage(playerid,0xEFEFF7AA,"Használat: /lean [1-2]");
    	}
    	return 1;
    }
    ...
    {
        if (!strlen(cmdtext[7])) return SendClientMessage(playerid,0xEFEFF7AA,"Használat: /strip [A-G]");
    	switch (cmdtext[7])
    	{
        	...
        	default: SendClientMessage(playerid,0xEFEFF7AA,"Használat: /strip [A-G]");
    	}
    	return 1;
    }
	...
	// START DANCING
 	if(strcmp(cmd, "/dance", true) == 0) {
			...
			if(!strlen(tmp)) {
				SendClientMessage(playerid,0xFF0000FF,"Használat: /dance [style 1-4]");
				return 1;
			}
